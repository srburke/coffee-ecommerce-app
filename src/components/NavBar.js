                    ...
                    <div className="collapse navbar-collapse flex-grow-1" id="collapsibleNavId">
                        <ul className="navbar-nav mx-auto">
                            <li className="nav-item">
                                <Link to='/coffee-ecommerce-app' id="link" className="nav-link" aria-current="page">Home<span
                            ...
                            <li class="nav-item dropdown" id="link">
                                ...
                                <ul className="dropdown-menu">
                                    <li><a href='/coffee-ecommerce-app/coffee-type/light' className="nav-link" id='link'>Light Roast</a></li>
