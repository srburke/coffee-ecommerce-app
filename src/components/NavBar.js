                        ...
                        <ul className="navbar-nav mx-auto">
                            ...
                            <li class="nav-item dropdown" id="link">
                                ...
                                <ul className="dropdown-menu">
                                    <li><a href='/coffee-ecommerce-app/coffee-ecommerce-app/coffee-type/light' className="nav-link" id='link'>Light Roast</a></li>
                                    <li><a href='/coffee-ecommerce-app/coffee-ecommerce-app/coffee-type/medium' className="nav-link" id="link">Medium Roast</a></li>
                                    <li><a href='/coffee-ecommerce-app/coffee-ecommerce-app/coffee-type/dark' className="nav-link" id="link">Dark Roast</a></li>
                                </ul>
                            </li>
